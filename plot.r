...
# Built in the dataset package are various
...
# give plot function catergorical variable in iris data frame
...
# y-axis is telling us the petal width range for the speices
